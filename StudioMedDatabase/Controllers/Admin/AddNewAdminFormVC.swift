...
class AddNewAdminFormVC: UIViewController {
            ...
            Auth.auth().createUser(withEmail: emailText.text!, password: passwordText.text!) { (user, error) in
                ...
                if error == nil {
                    ...
                    if self.firstNameText.text == "" || self.lastNameText.text == "" || self.phoneNumberText.text == "" || self.zipCodeText.text == "" || self.emailText.text == "" || self.passwordText.text == "" {
                        ...
                        let childUpdates = ["/admin/adminUsers/\(key)": post]
                        self.ref.updateChildValues(childUpdates)
                        print("new admin successfully created")
                        AlertView.addNewAdminAlert(view: self, alertTitle: "Success!", alertMessage: "new admin successfully created")
...
extension AddNewAdminFormVC: UITextFieldDelegate {
...
private extension AddNewAdminFormVC {
