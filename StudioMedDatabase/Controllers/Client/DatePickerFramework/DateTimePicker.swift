...
@objc public class DateTimePicker: UIView {
    ...
    @objc open class func show(selected: Date? = nil, minimumDate: Date? = nil, maximumDate: Date? = nil, timeInterval: MinuteInterval = .default) -> DateTimePicker {
        ...
        //dateTimePicker.minimumDate = minimumDate ?? Date(timeIntervalSinceNow: -3600 * 24 * 30)
        dateTimePicker.minimumDate = Date()
        dateTimePicker.maximumDate = Date(timeIntervalSinceNow: 3600 * 24 * 30)
...
//        }
        ...
        for i in 0..<dates.count {
            print("dates count is: \(dates.count)")
            let date = dates[i]
